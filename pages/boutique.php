...
<div class="row">
    <div class="col-md-3 text-center border-end border-bottom border-2 border-danger back-image text-white position-fixed" height="100%">
        ...
        <a class="dropdown-item pt-1 pb-3 text-white" type="button" href="">
            <h3>Nouveauté</h3>
        </a>
        <div class="dropdown-divider pt-3"></div>
        <a class="dropdown-item pt-1 pb-3 text-white" type="button" href="">
        ...
        <div class="dropdown-divider pt-3"></div>
        <a class="dropdown-item pt-1 pb-4 text-white" type="button" href="">
            <h3>Figurines</h3>
        </a>
    </div>
</div>
<div class="row">
    ...
    <div class="col-md card-group mt-2 me-3">
        <div class="card">
            <img src="../jeux_covers/51HlW5jBN-L._AC_.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="card">
            <img src="../jeux_covers/A1GoGM6suxL._AC_SX385_.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="card">
            <img src="../jeux_covers/Final_Fantasy_XIII_cover.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="card-group">
            <div class="card">
                <img src="../jeux_covers/ff132.jpg" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="card">
                <img src="../jeux_covers/jaquette.jpg" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="card">
                <img src="../jeux_covers/ff12+cover.jpg" class="card-img-top" alt="...">
                <div class="card-body">
